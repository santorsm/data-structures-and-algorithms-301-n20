...
const createServer = () => {
  ...
  app.delete('/things/1', (req, res) =>{
    res.status(405).send('Something\'s amiss');
  })
...
const toTitleCase = (arr) => {
  // Solution code here...
  const upperFirstLetterArray = arr.map(i => {
    const firstCapital = i[0].toUpperCase();
    const updatedWords = i.slice(1);
      return firstCapital + updatedWords;
  });
